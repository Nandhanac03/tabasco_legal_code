...
// Prepare SQL Query
$sql = "SELECT name, code, address, contact_no, email FROM legal_third_party WHERE 1";
$params = [];
$types = "";
...
$sheet->setTitle('Legal Third Party');
...
header('Content-Disposition: attachment; filename="legal_third_party_' . date("Y-m-d_H-i-s") . '.xlsx"');
