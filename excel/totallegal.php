...
$filters = [
    'status' => 'A',
    // 'legal_status' omitted to show ALL statuses
    'dateon' => $fromDate,
    'search' => $search,
...
// Set Headers
$headers = ["Code", "Date", "Marketing", "Client", "Present Legal Firm", "Case Status", "Legal Status", "Claim Amount", "Collection Received", "Balance to Claim", "Expense"];
...
header('Content-Disposition: attachment; filename="total_legal_report_' . date("Y-m-d_H-i-s") . '.xls"');
