...
// Prepare SQL Query
$sql = "SELECT  name, code, address, contact_no, email FROM legal_debt_collector WHERE 1";
$params = [];
$types = "";
...
header('Content-Disposition: attachment; filename="legal_debt_collector_' . date("Y-m-d_H-i-s") . '.xlsx"');
