...
// No legal_status restriction — show all statuses (matches the AJAX loader behaviour)
$filters = [
    'status'  => 'A',
...
$sheet->setTitle('Client Base Action Report');

// Headers — match the report table columns
...
header('Content-Disposition: attachment; filename="client_base_action_report_' . date("Y-m-d_H-i-s") . '.xls"');
