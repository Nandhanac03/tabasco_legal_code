    ...
    <div class="ms-auto ">
                <div class="btn-group">
                    <button type="button" class="btn btn-primary"
                        onclick="window.location.href='<?= ROOT_DIR ?>legalteam/information.html';"><i
                            class="fadeIn animated bx bx-plus"></i>New Team</button>
                </div>
            </div>
</div>
<!-- End Breadcrumb -->
...
var keyword     = $("#text_keyword").val();
  $.ajax({
      url: "<?= ROOT_DIR ?>modules/legalteam/ajax/loadLegalteam.php",
      type: "POST",
      cache: false,
      data: {
