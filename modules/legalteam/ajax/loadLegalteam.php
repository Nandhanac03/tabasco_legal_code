...
$totalData = $ObjUsersClass->Get_Users_TOTAL_COUNT( 'A', $keyword,23)[0]['TOTAL_RECORDS'];
$usersList = $ObjUsersClass->get_all_Users(null, $keyword, 23,$offset, $limit);
...
if ($totalData > 0) {
    ...
    foreach ($usersList as $userRows) {
        $rows[] = '<tr>
                    ...
                    <td>
                        <a type="button" href="' . ROOT_DIR . 'legalteam/information/edit/' . intval($userRows['user_Id'] ?? 0) . '.html" class="btn btn-primary" title="View">
