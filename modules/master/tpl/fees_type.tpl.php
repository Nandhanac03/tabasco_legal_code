            ...
            <div class="ms-auto ">
                ...
                <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        ...
                        data-bs-target="#exampleModal"><i class="fadeIn animated bx bx-plus"></i>New Fees type</button>
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <label class="form-label">Fees type <span class="text-danger">*</span></label>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="deleteModalLabel">Delete Fees type</h5>
...
<script>
    ...
    function loadCategory(search = '', pageNo = 1) {
        ...
        $.ajax({
            ...
            url: '<?= ROOT_DIR ?>modules/master/ajax/fees_type.php',
