                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="">
                                ...
                                <a href="<?= ROOT_DIR ?>reports/expense_report_list.html" class="btn btn-dark"><ion-icon name="return-down-back-outline"></ion-icon>BACK</a>
                                    ...
                                    <?php if ($legal_case) { ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= ROOT_DIR ?>reports/expense_report/view/<?= $case['id'] ?>.html" class="text-dark btn"><i
