...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Client base Action report Update</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Client base Action report</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-3">
                            <div id="load_ajax_clientbaseaction_report_list"></div>
                        </div>
...
$(document).ready(function() {
    ...
    // CHANGE 1: Declare currentFilters at top so all functions share it
    var currentFilters = {
        case_id:   '',
        client_id: ''
    };

    // CHANGE 2: loadData accepts page + filters, sends both to backend
    function loadData(page, filters) {
        filters = filters || currentFilters;

        $.ajax({
            url: "<?= ROOT_DIR ?>modules/reports/ajax/load_ajax_clientbaseaction_report_list.php",
            type: "POST",
            cache: false,
            data: {
                page_no:   page,
                case_id:   filters.case_id,   // CHANGE 2: matches backend $_POST['case_id']
                client_id: filters.client_id  // CHANGE 2: matches backend $_POST['client_id']
            },
            success: function(response) {
                $("#load_ajax_clientbaseaction_report_list").html(response);
            }
        });
    }

    // CHANGE 3: Initial load inside ready()
    loadData(1, currentFilters);

    // CHANGE 4: When Case is selected, auto-fill matching Client
    $('#sort_by_case').on('change', function() {
        var clientId = $(this).find(':selected').data('client-id');
        $('#sort_by_client_name').val(clientId || '');
    });

    // CHANGE 5: Search form — read dropdowns, save to currentFilters, reload page 1
    ...
    // CHANGE 6: Reset — clear dropdowns and filters, reload
    ...
    // CHANGE 7: Pagination preserves currentFilters across pages
