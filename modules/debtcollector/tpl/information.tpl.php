        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Debt Collector Information</li>
                </ol>
            </nav>
        </div>
    </div>
...
<?php
echo createNavItem('debtcollector', "Information", "information-sharp", "information", $edit_id, true); // Active tab
echo createNavItem('debtcollector', "Documents", "document-attach-sharp", "document", $edit_id);        // Inactive tab

echo createNavItem('debtcollector', "Contact", "person-add-outline", "contact", $edit_id);        // Inactive tab

echo createNavItem('debtcollector', "Commission", "cash", "commission", $edit_id);        // Inactive tab
?>
 </ul>
                            ...
                            <div class="tab-pane fade show active" id="primaryhome" role="tabpanel">
                                ...
                                <section class="shop-page">
                                    <div class="shop-container">
                                        <div class="shop-cart">
                                            <div class="container">
<form method="POST" enctype="multipart/form-data" id="frm_debtCollector" name="frm_debtCollector" action="">
                                                <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="col">
                                                        <div class="card">
<div class="card-header">
    <h6 class="mb-0"><i class="lni lni-user"></i> Debt Collector Profile</h6>
</div>
<div class="card-body">
...
<input type="hidden" class="form-control" id="ac_id" name="ac_id" value="<?= ($action == 'edit') ? htmlspecialchars($bank_detals['ac_id']) : '' ?>" autocomplete="off" readonly="true"  />
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="code" name="code" value="<?=$data['code']?>" autocomplete="off" readonly="true" readonly="true"  required/>
</div>
<div class="mb-3">
    <label class="form-label">Debt Collector Name: <span class="asterisk text-danger">*</span></label>
    <input type="text" class="form-control" id="name" name="name" value="<?=$data['name']?>" autocomplete="off" required/>
</div>
<div class="mb-3">
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="post_box_no" name="post_box_no" value="<?=$data['post_box_no']?>" autocomplete="off" />
</div>
<div class="mb-3">
