                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0 align-items-center">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Debt Collector Commission</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-primary" role="tablist">
                            ...
                            echo createNavItem('debtcollector', "Commission", "cash", "commission", $edit_id, true);        // Active tab
                            ?>
                        </ul>
