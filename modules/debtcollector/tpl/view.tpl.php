    ...
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center">
                ...
                <div class="breadcrumb-title pe-3">Debt Collector View</div>
                        ...
                        <ul class="dropdown-menu">
                            <?php if (LEGAL_AUTH_EDIT): ?>
                                <li><a class="dropdown-item"
                                        href="<?= ROOT_DIR . 'debtcollector/information/edit/' . intval($data['id'] ?? 0) . '.html' ?>"><i
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                            onclick="window.location.href='<?= ROOT_DIR . 'debtcollector/information/delete/' . intval($data['id'] ?? 0) . '.html' ?>'">Yes</button>
