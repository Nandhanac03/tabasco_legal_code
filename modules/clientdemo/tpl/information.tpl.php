        ...
        <div class="card">
          <div class="card-body">
            <ul class="nav nav-tabs nav-primary" role="tablist">
              <?php
              echo createNavItem('clientdemo', "Information", "information-sharp", "information", $edit_id, true);
...
<script>
  ...
  function listClient(marketingId, clientId) {
    ...
    if (marketingId) {
      $.ajax({
        url: '<?= ROOT_DIR ?>modules/clientdemo/ajax/get_client.php', // Adjust as needed
        type: 'POST',
        data: {
