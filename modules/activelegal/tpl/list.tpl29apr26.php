...
<script type="text/javascript">
  ...
  function loadData(page, filters = null) {
    // If no filters provided (e.g. from pagination click), gather them from the form
    if (filters === null || Object.keys(filters).length === 0) {
      filters = {
        fromDate: document.getElementById('fromDate').value,
        search_code: document.getElementById('search_code').value,
        select_case_id: document.getElementById('sort_by_case').value,
        select_client_id: document.getElementById('sort_by_client_name').value
      };
    }
