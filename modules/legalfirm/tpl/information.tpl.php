        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Legal Firm Information</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-primary" role="tablist">
                            <?php
                            echo createNavItem('legalfirm', "Information", "information-sharp", "information", $edit_id, true); // Active tab
                            echo createNavItem('legalfirm', "Documents", "document-attach-sharp", "document", $edit_id);        // Inactive tab

                            echo createNavItem('legalfirm', "Contact", "person-add-outline", "contact", $edit_id);        // Inactive tab

                            echo createNavItem('legalfirm', "Commission", "cash", "commission", $edit_id);        // Inactive tab
                            ?>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="primaryhome" role="tabpanel">
                                ...
                                <section class="shop-page">
                                    <div class="shop-container">
                                        <div class="shop-cart">
                                            <div class="container">
                                            <form method="POST" enctype="multipart/form-data" id="frm_legalFirm" name="frm_legalFirm" action="">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="col">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <h6 class="mb-0"><i class="lni lni-user"></i> Legal
                                                                        Firm
                                                                        Profile</h6>
                                                                </div>
                                                                <div class="card-body">
...
<div class="mb-3">
    <label class="form-label">Firm Name: <span class="asterisk text-danger">*</span></label>
