    ...
    <div class="ps-3 d-none d-sm-block">
        ...
        <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb mb-0 p-0 align-items-center">
                ...
                <li class="breadcrumb-item active" aria-current="page">Legal Firm List</li>
...
<button type="button" class="btn btn-primary" onclick="window.location.href='<?= ROOT_DIR ?>legalfirm/information.html';">
        <i class="fadeIn animated bx bx-plus"></i>Add Legal Firm</button>
 <?php endif; ?>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <form class="ms-auto position-relative" action="" id="form_dc" name="form_dc"
                                ...
                                <input class="form-control ps-5" type="text" id="keywordsearch" placeholder="search"
                        ...
                        <div class="table-responsive mt-3">
                            ...
                            <div id="load_legal_firm_data"></div>
                                ...
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control password_1" autocomplete="off"

                                                placeholder="Enter Password" />

                                            <span class="input-group-text" id="basic-addon1"><i

                                                    class="lni lni-eye"></i></span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control password_2" autocomplete="off"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function loadData(page) {
            ...
            $.ajax({
                ...
                url: "<?= ROOT_DIR ?>modules/legalfirm/ajax/load_legalfirm.php",
                ...
                success: function (response) {
                    ...
                    $("#load_legal_firm_data").html(response);
    ...
    $("#exportExcel").click(() => {
        ...
        var exportUrl = "<?= ROOT_DIR ?>excel/legalfirm.php?type=excel";
