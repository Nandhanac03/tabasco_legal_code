                              ...
                              <div class="card">
                                ...
                                <div class="card-body">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" value="<?= $data['total_outstanding'] ?? 0.00 ?>" id="total_outstanding" name="total_outstanding" autocomplete="off" readonly="true" onchange="set_Outstanding('<?= $_REQUEST['param1'] ?>')" />
                                  </div>
