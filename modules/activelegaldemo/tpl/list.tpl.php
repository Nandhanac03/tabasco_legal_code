      ...
      <?php if (LEGAL_AUTH_ADD): ?>
        <div class="ms-auto d-flex gap-2">
          ...
          <button type="button" class="btn btn-primary"
            ...
            onclick="window.location.href='<?= ROOT_DIR ?>activelegaldemo/information.html';">
...
<script>
  ...
  document.getElementById('legalStatusForm').addEventListener('submit', function(e) {
    ...
    $.ajax({
      url: "<?= ROOT_DIR ?>modules/activelegaldemo/ajax/changeLegalStatus.php",
      type: "POST",
      dataType: "json",
      data: {
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#deleteLegalBtn").click(function() {
      ...
      $.ajax({
        ...
        url: "<?= ROOT_DIR ?>modules/activelegaldemo/ajax/manage_active_legal.php",
  ...
  function loadData(page, filters = {}) {
    $.ajax({
      url: "<?= ROOT_DIR ?>modules/activelegaldemo/ajax/load_active_legal.php",
      type: "POST",
      cache: false,
      data: Object.assign({
        page_no: page,
  ...
  $("#category_type").change(function() {
    ...
    $.ajax({
      ...
      url: "<?= ROOT_DIR ?>modules/activelegaldemo/ajax/shift_active_legal.php",
