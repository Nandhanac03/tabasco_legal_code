         ...
         <div class="card-header py-3">
            <div class="row align-items-center g-3">
               ...
               <div class="col-12 col-lg-6 text-md-end">
                  ...
                  <a href="<?= ROOT_DIR?>activelegaldemo/list.html" class="btn btn-secondary"><ion-icon name="return-down-back-outline"></ion-icon>Back</a>
               </div>
            </div>
         </div>
                     ...
                     <?php if ($shifted_records) { ?>
                        <?php foreach ($shifted_records as $record) { ?>
                           <tr>
                              ...
                              <td>
                                 <h4>
                                    <ion-icon name="eye-outline" onclick="window.location.href='<?= ROOT_DIR ?>activelegaldemo/actionview/view/<?= $record['id'] ?>.html';"></ion-icon>
                                 </h4>
                              </td>
                           </tr>
                        <?php } ?>
...
<script>
   $(document).ready(function() {
      ...
      $("#notificationForm").on("submit", function(e) {
         ...
         $.ajax({
            type: "POST",
            url: "<?= ROOT_DIR ?>modules/activelegaldemo/ajax/case_notification.php", // change to your save route
            data: {
