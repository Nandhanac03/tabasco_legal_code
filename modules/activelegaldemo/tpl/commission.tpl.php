                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-primary" role="tablist">
                            ...
                            echo createNavItem('activelegaldemo', "Information", "information-sharp", "information", $edit_id); // Active tab

                            echo createNavItem('activelegaldemo', "Documents", "document-attach-sharp", "document", $edit_id);        // Inactive tab

                            echo createNavItem('activelegaldemo', "Contact", "person-add-outline", "contact", $edit_id);        // Inactive tab

                            echo createNavItem('activelegaldemo', "Commission", "cash", "commission", $edit_id, true);  
                              
                            echo createNavItem('activelegaldemo', "RelatedCases", "person-add-outline", "relatedcases", $edit_id);    // Inactive tab
...
<script>
    ...
    $("#category_select").change(function() {
        ...
        $.ajax({
            ...
            type: 'post',
            url: '<?= ROOT_DIR ?>modules/activelegaldemo/ajax/manage_commission.php',
            data: {
