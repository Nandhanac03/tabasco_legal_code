...
<td style="border: 1px solid #00000014; max-width:150px; min-width:150px;"
    onclick="window.location=\'' . ROOT_DIR . 'activelegaldemo/view/view/' . intval($row['id'] ?? 0) . '.html\'"
...
<td style="max-width:100px; min-width:100px; position: relative; vertical-align: top;">
   ...
   <td style="border: 1px solid #00000014;">
        ...
        // if //(defined('LEGAL_AUTH_VIEW') && LEGAL_AUTH_VIEW) {
            echo '
                    <a type="button" class="btn btn-success" href="' . ROOT_DIR . 'activelegaldemo/view/view/' . intval($row['id'] ?? 0) . '.html' . '"><i class="lni lni-eye"></i></a>';
        // }
     //   if (defined('LEGAL_AUTH_EDIT') && LEGAL_AUTH_EDIT) {
            echo '

                    <a type="button" href="' . ROOT_DIR . 'activelegaldemo/information/edit/' . intval($row['id'] ?? 0) . '.html" class="btn btn-dark" title="Edit"><i class="fadeIn animated bx bx-pencil"></i></a>
