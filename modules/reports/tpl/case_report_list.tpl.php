            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">UAE Pass report  </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-3">
                            ...
                            <div id="load_ajax_case_report_list"></div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function loadData(page, filters) {
            ...
            $.ajax({
                url: "<?= ROOT_DIR ?>modules/reports/ajax/load_ajax_case_report_list.php",
                type: "POST",
                cache: false,
                data: {
                    page_no:   page,
                ...
                success: function(response) {
                    $("#load_ajax_case_report_list").html(response);
                }
            });
        }
        ...
        $("#exportExcel").on("click", function() {
            ...
            var exportUrl = "<?= ROOT_DIR ?>excel/uae_pass_report.php?select_case_id=" + encodeURIComponent(case_id) + "&select_client_id=" + encodeURIComponent(client_id);
