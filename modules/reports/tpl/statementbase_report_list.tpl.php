...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Statement base report Update</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                        <li class="breadcrumb-item"><a href="javascript:;"><ion-icon name="home-outline"></ion-icon></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Statement base report  </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-3">
                            ...
                            <div id="load_ajax_statementbase_report_list"></div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function loadData(page, filters) {
            ...
            $.ajax({
                url: "<?= ROOT_DIR ?>modules/reports/ajax/load_ajax_statementbase_report_list.php",
                type: "POST",
                cache: false,
                data: {
                    page_no:   page,
                ...
                success: function(response) {
                    $("#load_ajax_statementbase_report_list").html(response);
                }
            });
        }
...
var exportUrl = "<?= ROOT_DIR ?>excel/statementbase.php?type=excel";
