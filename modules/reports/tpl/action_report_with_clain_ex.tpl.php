                            ...
                            <table class="table table-invoice">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-end" width="19%">Remarks</th>
                                    </tr>
                                    <?php if ($mergedData) { ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php if ($datacoll['document']) {
                                                    if ($datacoll['fees_type_title']  == 'Claim') {
                                                        $f_name = 'collection';
                                                    } else if ($datacoll['/']  == 'Case Action') {
                                                        $f_name = 'action_documents';
                                                    } else {
                                                        $f_name = 'expenses';
                                                    }
            ...
            <button type="button" class="btn text-success">
                <i class="fadeIn animated bx bx-file"></i>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-end" width="10%"><?= number_format($coll_amount, 2) ?></th>


                                        <th class="text-end" width="10%"><?= number_format($exp_amount, 2) ?></th>
