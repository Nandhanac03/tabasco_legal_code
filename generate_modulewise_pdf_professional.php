...
$mdPath = __DIR__ . '/MODULEWISE_DOCUMENTATION.md';
$pdfPath = __DIR__ . '/MODULEWISE_DOCUMENTATION_PROFESSIONAL.pdf';
...
<p>Module-Wise Elaborate Documentation</p>
...
$mpdf->SetTitle('Tabasco Legal - Module-Wise Documentation');
$mpdf->SetAuthor('Tabasco Legal Team');
$mpdf->SetSubject('Full Application Module Documentation');
$mpdf->SetCreator('Tabasco Legal System');
$mpdf->SetDisplayMode('fullpage');
$mpdf->SetHTMLHeader("<div style='font-size:9pt;color:#6b7280;border-bottom:1px solid #e5e7eb;padding-bottom:3pt;'>Tabasco Legal - Module Documentation</div>");
