                  ...
                  <?php if ($rootdetails) { ?>
                    <?php foreach ($rootdetails as $data) { ?>
                      <tr>
                        ...
                        <td><?= $_SESSION['LOGIN_LEGAL_NAME'] ?> - <?= $_SESSION['LOGIN_LEGAL_TYPE_NAME'] ?></td>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class=" p-3 rounded">
                        ...
                        <input type="hidden" id="case_id" value="<?= $cases[0]['id'] ?>">
                        ...
                        <div class="col-12">
                          ...
                          <input type="text" id="case_number" class="form-control" value="<?= $cases[0]['case_number'] ?>" readonly>
                        </div>
