...
<script>
    ...
    $('#btn_save').click(function(event) {
        ...
        const collectedAmount = parseFloat($('#collected_amount').val()) || 0;
        if (claimAmount < collectedAmount) {
            alert('Claim amount cannot be less than the amount already collected (' + collectedAmount.toFixed(2) + ').');
            return;
        }
