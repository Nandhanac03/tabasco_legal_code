                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-primary" role="tablist">
                            ...
                            <?php
                            echo createNavItem('client', "Information", "information-sharp", "information", $edit_id); // Inactive tab
                            echo createNavItem('client', "Documents", "document-attach-sharp", "document", $edit_id, true);        // Active tab
