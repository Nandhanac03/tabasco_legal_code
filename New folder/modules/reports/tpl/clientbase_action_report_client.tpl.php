...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Client base Action Report</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                        <li class="breadcrumb-item"><a href="javascript:;"><ion-icon name="home-outline"></ion-icon></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Client base Action Report List</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto ">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="">
                                ...
                                <a href="<?= ROOT_DIR ?>reports/client_base_action_report_list.html" class="btn btn-dark"><ion-icon name="return-down-back-outline"></ion-icon>BACK</a>
                                    ...
                                    <?php if ($legal_case) { ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= ROOT_DIR ?>reports/action_report_with_clain_ex/view/<?= $case['id'] ?>.html" class="text-dark btn"><i
