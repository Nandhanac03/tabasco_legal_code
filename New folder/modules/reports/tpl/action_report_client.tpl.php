                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-3">
                            ...
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    <?php if ($legal_precase || $legal_case) { ?>
                                        <?php if ($legal_precase) { ?>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $case_status ?></td>
                                                    <td>
                                                        <a href="<?= ROOT_DIR ?>reports/action_report/precaseview/<?= $case['id'] ?>.html" class="text-dark btn"><i
                                        ...
                                        <?php if ($legal_case) { ?>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $case_status ?></td>
                                                    <td>
                                                        <a href="<?= ROOT_DIR ?>reports/action_report/view/<?= $case['id'] ?>.html" class="text-dark btn"><i
                                                                class="lni lni-eye"></i></a>
                                                    </td>
                                                    </td>
                                                </tr>
