                            ...
                            <table class="table table-invoice">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" width=""><?= $legal_precase[0]['temp_case_number'] ?></td>
                                        <th>Case Start</th>


                                        <td class="text-right" width=""><?= $legal_precase[0]['register_date'] ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" width=""><?= $active_legal[0]['total_outstanding'] ?></td>
