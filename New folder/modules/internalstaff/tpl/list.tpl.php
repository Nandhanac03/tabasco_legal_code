    ...
    <div class="ms-auto ">
                <div class="btn-group">
                    <button type="button" class="btn btn-primary"
                        onclick="window.location.href='<?= ROOT_DIR ?>internalstaff/information.html';"><i
                            class="fadeIn animated bx bx-plus"></i>New Staff</button>
                </div>
            </div>
</div>
<!-- End Breadcrumb -->
          ...
          <div class="card">
              <div class="card-body">
                ...
                <div class="table-responsive mt-3"><div id="load_ajax_client"></div></div>
              </div>
            </div>
...
var keyword     = $("#text_keyword").val();
  $.ajax({
      url: "<?= ROOT_DIR ?>modules/internalstaff/ajax/loadinternalStaff.php",
      type: "POST",
      cache: false,
      data: {
