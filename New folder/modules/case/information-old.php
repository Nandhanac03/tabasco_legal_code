...
if ($_POST) {
    ...
    $go_forward = true;
    if ($_POST['code'] == '' || $_POST['case_number'] == '' || $_POST['category'] == '' || $_POST['court'] == '' || $_POST['plaintiff'] == '' || $_POST['register_date'] == '' || $_POST['case_mode'] == '' || $_POST['lawyer'] == '' || $_POST['location'] == '' || $_POST['plantiff'] == ''|| $_POST['defendant'] == '') {
    ...
    if ($go_forward) {
        ...
        $input_data['plantiff'] = $_POST['plantiff'];
        ...
        if ($objLegalCase->saveCase($input_data, $edit_id)) {
            ...
            $root_array['plantiff'] = $_POST['plantiff'];
            $root_array['defendant'] = $_POST['defendant'];
