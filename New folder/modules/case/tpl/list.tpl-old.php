...
<script>
    ...
    $("#saveRootButton").click(function() {
        ...
        let root_number = $("#root_cat_number").val()


        let goForward = validateForm(case_number, lawyer, court, stage, category, register_date);
    ...
    $("#updateRootButton").click(function() {
        ...
        let case_number = $("#edit_roots_case_number")

        let lawyer = $("#edit_roots_lawyer")

        let court = $("#edit_roots_court")

        let stage = $("#edit_roots_stage")

        let category = $("#edit_roots_category")

        let register_date = $("#edit_roots_register_date")
        let root_number = $("#edit_root_cat_number").val()
