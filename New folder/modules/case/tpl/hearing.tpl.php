                                                                ...
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <form enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label class="form-label">Hearing Feedback Date: <span class="text-danger">*</span></label>
                                                                                <input type="date" class="form-control" id="hearing_feedback_date">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label class="form-label">Upload: </label>
                                                                                <input type="file" class="form-control" id="hearing_file">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label class="form-label">Notes / Remarks: <span class="text-danger">*</span></label>
                                                                                <input type="text" class="form-control" id="remarks">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <button type="button" class="btn btn-primary px-5 mb-1" id="save_hearing_btn">Save</button>
                                                                                <button type="reset" class="btn btn-secondary px-5 mb-1" id="reset_hearing_btn">Reset</button>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
