                ...
                <div class="countries-list">
                  <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="country-icon">
                      <img src="<?= ROOT_DIR ?>assets/images/icons/usa.png" alt="" width="35">
                    </div>
                  ...
                  <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="country-icon">
                      <img src="<?= ROOT_DIR ?>assets/images/icons/india.png" alt="" width="35">
                    </div>
                    <div class="country-name flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="country-icon">
                      <img src="<?= ROOT_DIR ?>assets/images/icons/china.png" alt="" width="35">
                    </div>
                    <div class="country-name flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="country-icon">
                      <img src="<?= ROOT_DIR ?>assets/images/icons/russia.png" alt="" width="35">
                    </div>
                    <div class="country-name flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="country-icon">
                      <img src="<?= ROOT_DIR ?>assets/images/icons/australia.png" alt="" width="35">
                    </div>
                    <div class="country-name flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="country-icon">
                      <img src="<?= ROOT_DIR ?>assets/images/icons/brazil.png" alt="" width="35">
                    </div>
                    <div class="country-name flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3 mb-0">
                    <div class="country-icon">
                      <img src="<?= ROOT_DIR ?>assets/images/icons/UAE.png" alt="" width="35">
                    </div>
                    <div class="country-name flex-grow-1">
                  ...
                  <table class="table table-borderless align-middle mb-0">
                    <tbody>
                      <tr>
                        <td>
                          <div class="country-icon">
                            <img src="<?= ROOT_DIR ?>assets/images/icons/india.png" alt="" width="32">
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="country-icon">
                            <img src="<?= ROOT_DIR ?>assets/images/icons/usa.png" alt="" width="32">
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="country-icon">
                            <img src="<?= ROOT_DIR ?>assets/images/icons/china.png" alt="" width="32">
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="country-icon">
                            <img src="<?= ROOT_DIR ?>assets/images/icons/russia.png" alt="" width="32">
                          </div>
                        </td>
                        <td>
                ...
                <tbody>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="product-box border">
                          <img src="<?= ROOT_DIR ?>assets/images/products/11.png" alt="">
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="product-box border">
                          <img src="<?= ROOT_DIR ?>assets/images/products/07.png" alt="">
                        </div>
                        <div class="product-info">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="product-box border">
                          <img src="<?= ROOT_DIR ?>assets/images/products/17.png" alt="">
                        </div>
                        <div class="product-info">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="product-box border">
                          <img src="<?= ROOT_DIR ?>assets/images/products/04.png" alt="">
                        </div>
                        <div class="product-info">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="product-box border">
                          <img src="<?= ROOT_DIR ?>assets/images/products/10.png" alt="">
                        </div>
                        <div class="product-info">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="product-box border">
                          <img src="<?= ROOT_DIR ?>assets/images/products/12.png" alt="">
                        </div>
                        <div class="product-info">
