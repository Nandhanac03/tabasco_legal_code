                    ...
                    <tbody>
                       ...
                       <td>1</td>
                        <td>
                          <div class="d-flex align-items-center gap-3 cursor-pointer">
                             <img src="<?= ROOT_DIR ?>assets/images/avatars/01.png" class="rounded-circle" width="44" height="44" alt="">
                             <div class="">
                      ...
                      <tr>
                       <td>2</td>
                        <td>
                          <div class="d-flex align-items-center gap-3 cursor-pointer">
                             <img src="<?= ROOT_DIR ?>assets/images/avatars/02.png" class="rounded-circle" width="44" height="44" alt="">
                             <div class="">
                      ...
                      <tr>
                       <td>3</td>
                        <td>
                          <div class="d-flex align-items-center gap-3 cursor-pointer">
                             <img src="<?= ROOT_DIR ?>assets/images/avatars/03.png" class="rounded-circle" width="44" height="44" alt="">
                             <div class="">
                      ...
                      <tr>
                       <td>4</td>
                        <td>
                          <div class="d-flex align-items-center gap-3 cursor-pointer">
                             <img src="<?= ROOT_DIR ?>assets/images/avatars/04.png" class="rounded-circle" width="44" height="44" alt="">
                             <div class="">
                               <p class="mb-0">Maria Anders</p>
                             </div>
                          </div>
                      ...
                      <tr>
                       <td>5</td>
                        <td>
                          <div class="d-flex align-items-center gap-3 cursor-pointer">
                             <img src="<?= ROOT_DIR ?>assets/images/avatars/05.png" class="rounded-circle" width="44" height="44" alt="">
                             <div class="">
                      ...
                      <tr>
                       <td>6</td>
                        <td>
                          <div class="d-flex align-items-center gap-3 cursor-pointer">
                             <img src="<?= ROOT_DIR ?>assets/images/avatars/06.png" class="rounded-circle" width="44" height="44" alt="">
                             <div class="">
                               <p class="mb-0">Martin Loother</p>
                             </div>
                          </div>
                ...
                <div class="table-responsive mt-3">
                  <table class="table align-middle mb-0">
                    <thead class="table-light">
                     ...
                     <tbody><tr>
                      <td>Sport Shoes</td>
                      <td><img src="<?= ROOT_DIR ?>assets/images/products/01.png" class="product-img-2" alt="product img"></td>
                      <td>#9405822</td>
                     ...
                     <tr>
                      <td>Man Headcap</td>
                      <td><img src="<?= ROOT_DIR ?>assets/images/products/02.png" class="product-img-2" alt="product img"></td>
                      <td>#8304620</td>
                     ...
                     <tr>
                      <td>Sunglass</td>
                      <td><img src="<?= ROOT_DIR ?>assets/images/products/03.png" class="product-img-2" alt="product img"></td>
                      <td>#4736890</td>
                     ...
                     <tr>
                      <td>Shirt Formal</td>
                      <td><img src="<?= ROOT_DIR ?>assets/images/products/04.png" class="product-img-2" alt="product img"></td>
                      <td>#8543765</td>
                      <td><span class="badge bg-light-success text-success w-100">Paid</span></td>
                      <td>$1200.00</td>
                      <td>14 Feb 2020</td>
                     ...
                     <tr>
                      ...
                      <td><img src="<?= ROOT_DIR ?>assets/images/products/06.png" class="product-img-2" alt="product img"></td>
                      <td>#9629240</td>
                      <td><span class="badge bg-light-warning text-warning w-100">Pending</span></td>
                      <td>$1500.00</td>
                      <td>18 Feb 2020</td>
                     ...
                     <tr>
                      <td>Heals</td>
                      <td><img src="<?= ROOT_DIR ?>assets/images/products/05.png" class="product-img-2" alt="product img"></td>
                      <td>#8506790</td>
                      <td><span class="badge bg-light-danger text-danger w-100">Failed</span></td>
                      <td>$1800.00</td>
                      <td>21 Feb 2020</td>
