            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Total Legal Contact</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <li class="nav-item" role="presentation">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" href="<?= ROOT_DIR ?>totallegal/contact.html">
                                    <div class="d-flex align-items-center">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="d-flex align-items-center">
                                                                    <h5 class="mb-0"><i class="lni lni-list"></i> Contact Listing</h5>
                                                                    <form class="ms-auto position-relative">
                                                                        <button type="button"
                                                                            class="btn btn-primary btn-sm text-uppercase rounded font-13 fw-500" data-bs-toggle="modal" data-bs-target="#exampleExtraLargeModal"><i
