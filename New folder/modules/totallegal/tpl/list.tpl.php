      ...
      <div class="ps-3 d-none d-sm-block">
        ...
        <nav aria-label="breadcrumb">
          ...
          <ol class="breadcrumb mb-0 p-0 align-items-center">
            ...
            <li class="breadcrumb-item active" aria-current="page">Total Legal List</li>
...
<input class="form-control" type="text" placeholder="Search by Firm" id="search_firm">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive mt-3" style="overflow-y:auto!important;">
...
<script>
  ...
  document.getElementById('legalStatusForm').addEventListener('submit', function(e) {
    ...
    $.ajax({
      url: "<?= ROOT_DIR ?>modules/activelegal/list.php",
      type: "POST",
      dataType: "json",
      data: {
