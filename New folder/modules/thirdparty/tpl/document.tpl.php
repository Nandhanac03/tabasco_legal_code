        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Third Party Document</li>
                </ol>
            </nav>
        </div>
    </div>
...
<?php include("common/backButton_list.php");?>
        ...
        <div class="row">
            <div class="col col-lg-12 mx-auto">
              ...
              echo createNavItem('thirdparty', "Documents", "document-attach-sharp", "document", $edit_id,true);        // Active tab
