    ...
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center">
                ...
                <div class="breadcrumb-title pe-3">Third Party View </div>
...
<?php if (LEGAL_AUTH_EDIT): ?>
                            <li><a class="dropdown-item"
                                    ...
                                    href="<?= ROOT_DIR . 'thirdparty/information/edit/' . intval($data['id'] ?? 0) . '.html' ?>"><i
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                            ...
                            onclick="window.location.href='<?= ROOT_DIR . 'thirdparty/information/delete/' . intval($data['id'] ?? 0) . '.html' ?>'">Yes</button>
                            ...
                            <div class="bs-stepper-content">
                                ...
                                <form onSubmit="return false">
                                    ...
                                    <div id="test-vl-1" role="tabpane3" class="bs-stepper-pane content fade"
                                        ...
                                        <h5 class="mb-1">Profile <span class="text-danger"><?= $data['locked_status'] == 'Y' ? ' (<i class="fadeIn animated bx bx-lock"></i>Locked ) ' : '' ?></span></h5>
