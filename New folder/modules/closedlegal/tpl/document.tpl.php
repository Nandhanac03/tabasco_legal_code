            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Closed Legal Documents</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-primary" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" href="<?= ROOT_DIR ?>closedlegal/document.html">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link " href="<?= ROOT_DIR ?>closedlegal/contact.html">
                                    <div class="d-flex align-items-center">
                                ...
                                <div class="card-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="doc_types">
                                                <option value="" selected>Select</option>
                                                <option value="trading_license">Trading License</option>
                                        ...
                                        <div class="mb-3">
                                            <button type="submit" class="btn btn-primary px-4 mb-2"><i
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="mb-3 d-flex justify-content-end">
                                            <div class="mb-3 ">
                                                <button type="button" class="btn btn-success px-5 mb-2">Submit</button>
                                                <button type="reset" class="btn btn-secondary px-5 mb-2">Reset</button>
                                            </div>
                                        </div>
                                    </form>
