<?php
class Area extends Dbcon
{
    function Save_Area($data = [], $id = '')
    {
        $params = [];
        if ($id) {
            $Sqlcmd = "UPDATE";
    ...
    function Get_Area($id = '', $title = '', $not_id = '', $search = '', $limit = '', $offset = '')
    {
        $params = [];
        $Sqlcmd = "SELECT * FROM legal_area WHERE 1";
        if ($id) {
            $Sqlcmd .= " AND id=:id";
            $params['id'] = $id;
        }
    ...
    function Disable_Area($data = [], $id = '')
    {
        $params = [];
        $Sqlcmd = "UPDATE legal_area SET";
        if ($data['status']) {
            $Sqlcmd .= " status=:status";
            $params['status'] = $data['status'];
        }
