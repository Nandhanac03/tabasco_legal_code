<?php
class Court extends Dbcon
{
    function save_court($data = [], $id = '')
    {
        $params = [];
        if ($id) {
            $Sqlcmd = "UPDATE";
    ...
    function get_court($id = '', $title = '', $not_id = '', $search = '', $limit = '', $offset = '')
    {
        $params = [];
        $Sqlcmd = "SELECT * FROM legal_court WHERE 1";
        if ($id) {
            $Sqlcmd .= " AND id=:id";
            $params['id'] = $id;
        }
    ...
    function disable_court($data = [], $id = '')
    {
        $params = [];
        $Sqlcmd = "UPDATE legal_court SET";
        if ($data['status']) {
            $Sqlcmd .= " status=:status";
            $params['status'] = $data['status'];
        }
